...
(1, 'Гвианский арлекин', '<p>Знакомьтесь, Гвианский арлекин (Oreophrynella quelchii). Это крошечное (до 25 мм) земноводное из семейства настоящих жаб &nbsp;(Bufonidae). &nbsp;Обитает в Южной Америке на столовых горах Рорайма и Вэй-Ассипу (Венесуэла, Гайана и Бразилия) на высотах от 2 до 3 км. &nbsp;Где охотится на различных беспозвоночных.<br />\r\nЭти жабки обычно полностью черные, но часто встречаются особи с брюшком серого и желтого цвета. Из-за ареала обитания, утратили способность плавать. И им не нужна никакая вода для размножения. Самка откладывает яйца во влажную почву. &nbsp;Интересно, что это амфибии с прямым развитием &mdash; фаза головастика отсутствует, из яиц вылупляются уже сформированные жабки.<br />\r\nИз-за ограниченного ареала, вид находится в уязвимом положении.</p>', '2020-07-24 14:18:16', '2020-12-01 09:07:41', 1, 'photo_2020-11-15_23-35-18_1606820860.jpg'),
(3, 'Лягушка водонос', '<p>Лягушка водонос обладает массивной головой, за что и приобрела свое второе название &ndash; жаба-бык. Тело покрыто многочисленными складками различной длины. Последние находятся по бокам туловища и на спине. Между ними располагаются зернистые участки кожи, что доходят до области бедер. Задние конечности крупные и сильные. С их помощью лягушка роет глубокие убежища. У большинства представителей вида спина имеет яркий оливковый оттенок. Иногда встречаются особи бурого цвета. Вдоль позвоночника тянется светлая полоса. Брюхо имеет насыщенный желтый цвет. У молодых особей оно обладает белым оттенком. На горле содержатся темные отметины. Лягушка водонос имеет широкий рот с массивными челюстями. Внутри находится несколько рядов острых зубов. Служат они для захвата довольно крупной добычи. Такие земноводные способны достигать размера порядка 25 сантиметров. Что примечательно, тело некоторых представителей вида имеет ширину, практически идентичную длине. Относится это преимущественно к самцам. Ведь самки лягушек водоносов гораздо миниатюрнее. Их размеры обычно не превышают 12 сантиметров. Что касается веса представленных существ зафиксированы случаи, когда удавалось отловить водоносов массой более 2-х килограммов</p>', '2020-07-25 20:58:50', '2020-12-01 09:01:16', 1, 'photo_2020-12-01_13-00-16_1606820476.jpg'),
...
(1, 'Ноль Целковович', 'gleb-ruksha@rambler.ru', NULL, '$2y$10$XoV2MjfhS.oStdK5OjTEAug8bITKM2fdeBzziCHMU5/pmljq6e5Le', 'xh2qlrOHnGug08rnGZqNq7PqgfX6epZSrdrJzytuM67Zgxz65fyRjXVzx7HW', '2020-07-27 17:55:31', '2020-07-27 17:55:31'),
